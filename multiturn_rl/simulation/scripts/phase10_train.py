...
Usage: python simulation/scripts/phase10_train.py [--no-curriculum] [--no-shaping] [--timesteps N]
"""
...
def train(args: argparse.Namespace) -> dict:
    ...
    print("\nArtifacts:")
    print("  - simulation/artifacts/phase10_v3/models/best_model.zip")
    print("  - simulation/artifacts/phase10_v3/models/final_model.zip")
    print("  - simulation/artifacts/phase10_v3/tensorboard/")
    print("  - simulation/artifacts/phase10_v3/training_log.json")
    print("  - simulation/artifacts/phase10_v3/training_summary.json")
    return summary
