...
def cmd_phase10(args: argparse.Namespace, *, text_only: bool) -> None:
    ...
    pipeline = root / "multiturn_rl" / "simulation" / "scripts" / "phase10_full_pipeline.py"
...
def cmd_phase13(args: argparse.Namespace) -> None:
    root = _repo_root()
    script = root / "multiturn_rl" / "simulation" / "scripts" / "phase13_train.py"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p10_common.add_argument(
        "--artifacts-root",
        default=str(Path("multiturn_rl") / "simulation" / "artifacts"),
