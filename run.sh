...
#   NUM_TIMESTEPS_NUMERICAL   PPO steps, numerical RL       (default: 1000000)
#   NUM_TIMESTEPS_NLG         PPO steps, NLP mode           (default: auto — 5000 GPU / 100 CPU)
#   CB_COLLECT_EPISODES       bandit collect episodes       (default: 300)
#   CB_EVAL_EPISODES          bandit eval episodes          (default: 200)
#   EVAL_EPISODES             eval episodes, numerical/NLP  (default: 200)
#   N_ENVS                    parallel envs                 (default: 1)
#   HF_MODEL                  HF hub repo ID                (default: abhi6168/ABCD_CustomerAgent_Qwen_2.5_7b)
#   MOCK_LLM                  set to 1 to skip LLM loading  (default: auto on CPU-only)
