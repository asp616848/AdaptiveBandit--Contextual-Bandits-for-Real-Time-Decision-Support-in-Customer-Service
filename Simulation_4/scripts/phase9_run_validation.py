...
"""
Usage: python Simulation_4/scripts/phase9_run_validation.py

Runs all Phase 9 validation checks and writes:
- Console output: live PASS/FAIL for each check
- Simulation_4/artifacts/phase9/validation_report.json: machine-readable results
- Simulation_4/artifacts/phase9/validation_summary.txt: human-readable summary
...
from Simulation_4.validation.init import phase9_artifacts_root
from Simulation_4.validation.level1_statistical import run_level1
from Simulation_4.validation.level2_transition import run_level2
from Simulation_4.validation.level3_rl_signal import run_level3
from Simulation_4.validation.level4_rag_coverage import run_level4
