...
def main() -> int:
    ...
    logs_dir = (plots_dir / ".." / "logs").resolve()
    report_path = logs_dir / "full_pipeline_report.json"
    ...
    (logs_dir / "leaderboard.json").write_text(json.dumps(leaderboard, indent=2), encoding="utf-8")
